...
var game = null
var gParam = {ws_server:"localhost:8989/ws", user_name:"", joinroom:null, platform:"PC", app_token:null}
...
function bindNative() {
    ...
    connectWebViewJavascriptBridge(function(bridge) {
                                   ...
                                   bridge.callHandler("yesOrNoPopupWindow", {pop_title:title, pop_text:text,pop_btn1_text:button1Text, pop_btn2_text:button2Text}, function(data){
                                                      callback(data);
                                                      });
